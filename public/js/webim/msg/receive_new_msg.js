...
function onMsgReadedNotify (notify) {
  console.log('消息已读通知', notify)
  var sessMap = webim.MsgStore.sessMap()[webim.SESSION_TYPE.C2C + notify.C2cAccount]
  console.log(sessMap)
  if (sessMap) {
    ...
    console.debug('更新C2C未读数:', notify.C2cAccount, unread)
    /// /更新页面的未读数角标
    //
    // if (unread > 0) {
